...
public class HomeController {
	...
	public String lombok() {
		...
		coffeeDto.setCoffee_price(2000);
...
//		System.out.println("coffee3의 해쉬코드: " + coffee3.hashCode());
		...
		// Lombok이 구현해주는 equals()는 두 객체의 hashCode()가 일치할 때 true
//		System.out.println("coffee1과 coffee2의 해쉬코드가 다르므로 다른 객체: " + coffee1.equals(coffee2));
//		System.out.println("coffee2와 coffee3의 해쉬코드가 같으므로 같은 객체: " + coffee2.equals(coffee3));
		log.error("coffee1과 coffee2의 해쉬코드가 다르므로 다른 객체: {}", coffee1.equals(coffee2));
		log.error("coffee2와 coffee3의 해쉬코드가 같으므로 같은 객체: {}", coffee2.equals(coffee3));
